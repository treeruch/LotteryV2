...
public class LotteryModel {
	...
	public String getTodBack() {
		return todBack;
	}

	public void setTodBack(String todBack) {
		this.todBack = todBack;
	}

	public int getRiskSearch() {
		return riskSearch;
	}

	public void setRiskSearch(int riskSearch) {
		this.riskSearch = riskSearch;
	}
